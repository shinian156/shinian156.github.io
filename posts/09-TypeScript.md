...
- [一、TypeScript 基础](#一typescript-基础)
  - [1. TypeScript vs JavaScript](#1-typescript-vs-javascript)
  - [2. 安装与使用](#2-安装与使用)
- [二、基础类型](#二基础类型)
  - [1. 原始类型](#1-原始类型)
  - [2. 特殊类型](#2-特殊类型)
...
- [十二、tsconfig.json 配置](#十二tsconfigjson-配置)
  ...
  - [2. 常用选项说明](#2-常用选项说明)
- [十三、常见知识点](#十三常见知识点)
  - [1. TypeScript 的优势是什么？](#1-typescript-的优势是什么)
  - [2. any vs unknown 的区别？](#2-any-vs-unknown-的区别)
  - [3. interface vs type 的区别？](#3-interface-vs-type-的区别)
  - [4. 泛型的作用是什么？](#4-泛型的作用是什么)
  - [5. 什么是类型守卫？](#5-什么是类型守卫)
  - [6. enum 的优缺点？](#6-enum-的优缺点)
  - [7. 工具类型有哪些？](#7-工具类型有哪些)
  - [8. 什么是类型推断？](#8-什么是类型推断)
  - [9. readonly vs const 的区别？](#9-readonly-vs-const-的区别)
  - [10. declare 的作用是什么？](#10-declare-的作用是什么)
