...
- [一、数据类型](#一数据类型)
  - [1. 基本数据类型（7 种）](#1-基本数据类型7-种)
  - [2. 引用数据类型](#2-引用数据类型)
  - [3. typeof vs instanceof](#3-typeof-vs-instanceof)
- [二、深拷贝与浅拷贝](#二深拷贝与浅拷贝)
  - [1. 浅拷贝](#1-浅拷贝)
  - [2. 深拷贝](#2-深拷贝)
...
- [四、原型与原型链](#四原型与原型链)
  ...
  - [3. 继承](#3-继承)
- [五、this 指向](#五this-指向)
  - [1. this 的 4 种绑定规则](#1-this-的-4-种绑定规则)
  - [2. 箭头函数的 this](#2-箭头函数的-this)
...
- [七、Promise 与 Async/Await](#七promise-与-asyncawait)
  ...
  - [2. Promise.all vs Promise.race](#2-promiseall-vs-promiserace)
...
- [十、常见知识点](#十常见知识点)
  - [1. == 和 === 的区别？](#1-和-的区别)
  - [2. undefined 和 null 的区别？](#2-undefined-和-null-的区别)
  - [3. typeof null 返回 'object' 的原因？](#3-typeof-null-返回-object-的原因)
  - [4. map 和 forEach 的区别？](#4-map-和-foreach-的区别)
  - [5. 数组去重有哪些方法？](#5-数组去重有哪些方法)
  - [6. 防抖和节流的区别？](#6-防抖和节流的区别)
  - [7. call、apply、bind 的区别？](#7-callapplybind-的区别)
  - [8. 如何判断数组？](#8-如何判断数组)
  - [9. 深拷贝和浅拷贝的区别？](#9-深拷贝和浅拷贝的区别)
  - [10. 闭包是什么？有什么优缺点？](#10-闭包是什么有什么优缺点)
