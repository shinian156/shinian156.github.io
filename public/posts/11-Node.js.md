...
- [一、Node.js 基础](#一nodejs-基础)
  - [1. Node.js 是什么？](#1-nodejs-是什么)
  - [2. Node.js 特点](#2-nodejs-特点)
  - [3. Node.js 适用场景](#3-nodejs-适用场景)
- [二、事件循环（Event Loop）](#二事件循环event-loop)
  - [1. 事件循环机制](#1-事件循环机制)
  - [2. 执行顺序](#2-执行顺序)
  - [3. 微任务 vs 宏任务](#3-微任务-vs-宏任务)
- [三、模块系统](#三模块系统)
  - [1. CommonJS（Node.js 默认）](#1-commonjsnodejs-默认)
  - [2. ES Module（ESM）](#2-es-moduleesm)
  - [3. CommonJS vs ESM](#3-commonjs-vs-esm)
  - [4. 动态导入](#4-动态导入)
- [四、核心模块](#四核心模块)
  - [1. fs（文件系统）](#1-fs文件系统)
  - [2. path（路径处理）](#2-path路径处理)
  - [3. http（HTTP 服务器）](#3-httphttp-服务器)
  - [4. events（事件发射器）](#4-events事件发射器)
  - [5. stream（流）](#5-stream流)
  - [6. buffer（缓冲区）](#6-buffer缓冲区)
- [五、异步编程](#五异步编程)
  - [1. 回调函数](#1-回调函数)
  - [2. Promise](#2-promise)
  - [3. Async/Await](#3-asyncawait)
  - [4. 串行 vs 并行](#4-串行-vs-并行)
- [六、错误处理](#六错误处理)
  - [1. try/catch](#1-trycatch)
  - [2. error 事件（未捕获的异常）](#2-error-事件未捕获的异常)
  - [3. domain（已废弃）](#3-domain已废弃)
- [七、进程与线程](#七进程与线程)
  - [1. process（当前进程）](#1-process当前进程)
  - [2. child_process（子进程）](#2-child_process子进程)
  - [3. cluster（集群）](#3-cluster集群)
- [八、性能优化](#八性能优化)
  - [1. 避免阻塞主线程](#1-避免阻塞主线程)
  - [2. 使用流处理大文件](#2-使用流处理大文件)
  - [3. 缓存](#3-缓存)
  - [4. 连接池](#4-连接池)
- [九、安全](#九安全)
  - [1. 输入验证](#1-输入验证)
  ...
  - [4. CORS](#4-cors)
- [十、常见知识点](#十常见知识点)
  - [1. Node.js 是单线程的吗？](#1-nodejs-是单线程的吗)
  - [2. 什么是事件循环？](#2-什么是事件循环)
  - [3. process.nextTick 和 setImmediate 的区别？](#3-processnexttick-和-setimmediate-的区别)
  - [4. CommonJS 和 ESM 的区别？](#4-commonjs-和-esm-的区别)
  - [5. 什么是流（Stream）？](#5-什么是流stream)
  - [6. 如何处理错误？](#6-如何处理错误)
  - [7. Node.js 如何处理并发？](#7-nodejs-如何处理并发)
  - [8. 什么是 cluster？](#8-什么是-cluster)
  - [9. Buffer 的作用是什么？](#9-buffer-的作用是什么)
  - [10. Node.js 适用场景有哪些？](#10-nodejs-适用场景有哪些)
