...
- [1. 闭包（Closure）](#1-闭包closure)
  - [1.1 什么是闭包？](#11-什么是闭包)
  - [1.2 闭包的特点](#12-闭包的特点)
  - [1.3 闭包示例](#13-闭包示例)
  - [1.4 闭包的经典案例](#14-闭包的经典案例)
  - [1.5 闭包的优缺点](#15-闭包的优缺点)
  - [1.6 闭包的常见应用场景](#16-闭包的常见应用场景)
- [2. 防抖和节流](#2-防抖和节流)
  - [2.1 防抖（Debounce）](#21-防抖debounce)
  - [2.2 节流（Throttle）](#22-节流throttle)
  - [2.3 防抖和节流的区别](#23-防抖和节流的区别)
- [3. Promise](#3-promise)
  - [3.1 Promise 状态](#31-promise-状态)
  - [3.2 Promise 基本用法](#32-promise-基本用法)
  - [3.3 Promise 链式调用](#33-promise-链式调用)
  - [3.4 Promise 并发处理](#34-promise-并发处理)
  - [3.5 手写 Promise](#35-手写-promise)
  - [3.6 Promise 常见问题](#36-promise-常见问题)
...
- [5. 深拷贝和浅拷贝](#5-深拷贝和浅拷贝)
  - [5.1 浅拷贝](#51-浅拷贝)
  - [5.2 深拷贝](#52-深拷贝)
  - [5.3 拷贝常见问题](#53-拷贝常见问题)
- [6. 函数柯里化](#6-函数柯里化)
  - [6.1 什么是柯里化？](#61-什么是柯里化)
  - [6.2 基础实现](#62-基础实现)
  - [6.3 通用柯里化函数](#63-通用柯里化函数)
- [7. 面试高频题](#7-面试高频题)
  - [Q1: 闭包的应用场景？](#q1-闭包的应用场景)
  - [Q2: 防抖和节流的区别？](#q2-防抖和节流的区别)
  - [Q3: Promise 的状态有哪些？](#q3-promise-的状态有哪些)
  - [Q4: 如何实现深拷贝？](#q4-如何实现深拷贝)
  - [Q5: call、apply、bind 的区别？](#q5-callapplybind-的区别)
- [8. 总结](#8-总结)
