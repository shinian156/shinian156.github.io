...
- [1. ECharts 的基本概念和核心特点](#1-echarts-的基本概念和核心特点)
  - [1.1 什么是 ECharts？](#11-什么是-echarts)
  - [1.2 ECharts 的核心特点](#12-echarts-的核心特点)
- [2. ECharts 的配置项](#2-echarts-的配置项)
  - [2.1 基础配置结构](#21-基础配置结构)
  - [2.2 常用配置项说明](#22-常用配置项说明)
- [3. 常用图表类型](#3-常用图表类型)
  - [3.1 柱状图（Bar Chart）](#31-柱状图bar-chart)
  - [3.2 折线图（Line Chart）](#32-折线图line-chart)
  - [3.3 饼图（Pie Chart）](#33-饼图pie-chart)
  - [3.4 散点图（Scatter Chart）](#34-散点图scatter-chart)
- [4. 高级特性](#4-高级特性)
  - [4.1 动态数据更新](#41-动态数据更新)
  - [4.2 响应式布局](#42-响应式布局)
  - [4.3 动画配置](#43-动画配置)
  - [4.4 事件监听](#44-事件监听)
- [5. 性能优化](#5-性能优化)
...
- [6. 常见问题](#6-常见问题)
  ...
  - [6.2 图表变形](#62-图表变形)
  - [6.3 性能问题](#63-性能问题)
  - [6.4 图例点击不生效](#64-图例点击不生效)
- [7. 实战案例](#7-实战案例)
  - [7.1 柱状图 + 折线图混合](#71-柱状图-折线图混合)
  - [7.2 动态数据模拟](#72-动态数据模拟)
- [8. 面试高频题](#8-面试高频题)
  - [Q1: ECharts 和 Chart.js 的区别？](#q1-echarts-和-chartjs-的区别)
  - [Q2: 如何实现图表的动态数据更新？](#q2-如何实现图表的动态数据更新)
  - [Q3: 如何优化大数据量渲染性能？](#q3-如何优化大数据量渲染性能)
  - [Q4: 如何自定义图表样式？](#q4-如何自定义图表样式)
  - [Q5: 响应式图表如何实现？](#q5-响应式图表如何实现)
- [9. 进阶技巧](#9-进阶技巧)
  - [9.1 自定义主题](#91-自定义主题)
  - [9.2 组合图表](#92-组合图表)
  - [9.3 地图可视化](#93-地图可视化)
